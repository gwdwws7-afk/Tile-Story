...
[Serializable]
public class DTHarvestKitchenTaskData
{
    public List<DTHarvestKitchenTaskDatas> KitchenTaskDatas;

    public DTHarvestKitchenTaskDatas GetKitchenTaskDataById(int id)
    {
...
[Serializable]
public class DTHarvestKitchenTaskDatas
{
	public int ID;	// 任务ID
