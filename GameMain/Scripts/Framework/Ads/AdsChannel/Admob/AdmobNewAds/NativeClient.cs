...
{
	public class NativeClient : AndroidJavaProxy, INativeAdsClient
	{
			...
			: base("linkdesks.pop.bubblegames.customads.InterstitialListener_Admob")
		{
			...
			androidInterstitialAd = new AndroidJavaObject("linkdesks.pop.bubblegames.customads.Interstitial_Native_Admob", @static, this);
		}
