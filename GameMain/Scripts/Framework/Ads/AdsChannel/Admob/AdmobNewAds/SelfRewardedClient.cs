...
using System;
using UnityEngine;
	public class SelfRewardedClient : AndroidJavaProxy, ISelfRewardadClient
	{
		...
		public SelfRewardedClient()
			: base("linkdesks.pop.bubblegames.customads.InterstitialListener_Admob")
		{
			AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
			AndroidJavaObject @static = androidJavaClass.GetStatic<AndroidJavaObject>("currentActivity");
			androidInterstitialAd = new AndroidJavaObject("linkdesks.pop.bubblegames.customads.Rewardad_Admob", @static, this);
		}

		public void CreateRewardadAd()
		{
		}
