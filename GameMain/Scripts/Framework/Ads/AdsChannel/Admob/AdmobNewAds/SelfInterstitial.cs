...
{
	public class SelfInterstitial
	{
		private ISelfInterstitialClient client;
		...
		public SelfInterstitial(string adUnitId)
		{
		...
		internal ISelfInterstitialClient GetIAdsClient()
		{
#if UNITY_ANDROID
            return new GoogleMobileAds.Android.SelfInterstitialClient();
#endif
            return null;
		}
