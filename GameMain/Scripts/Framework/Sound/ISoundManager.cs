...
public interface ISoundManager
{
    ...
    /// <returns>是否增加声音组成功。</returns>
    bool AddSoundGroup(string soundGroupName, bool soundGroupAvoidBeingReplacedBySamePriority, bool soundGroupMute, float soundGroupVolume);
    ...
    List<int> GetAllLoadingSoundSerialIds();
    ...
    bool IsSoundForbidden(string soundAssetName);
    ...
    void ForbidSound(string soundAssetName, bool isForbid);
}
