...
public class GridFancyCell : FancyGridViewCell<int,GridContext>
{
	public override void UpdateContent(int itemData) {}
    public override void UpdatePosition(float position) { base.UpdatePosition(position); }
}

public class GridScrollView : FancyGridView<int, GridContext>
{
    class CellGroup : DefaultCellGroup { }

    [SerializeField] GridFancyCell cellPrefab = default;
