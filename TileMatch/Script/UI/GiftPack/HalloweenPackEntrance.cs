...
public class HalloweenPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("HalloweenPackMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > HalloweenPackMenu.GiftPackStartTime && DateTime.Now < HalloweenPackMenu.GiftPackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(HalloweenPackMenu.GiftPackEndTime);
