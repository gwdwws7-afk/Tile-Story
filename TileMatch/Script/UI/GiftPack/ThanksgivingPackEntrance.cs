...
public class ThanksgivingPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("ThanksgivingPackMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > ThanksgivingPackMenu.GiftPackStartTime && DateTime.Now < ThanksgivingPackMenu.GiftPackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(ThanksgivingPackMenu.GiftPackEndTime);
