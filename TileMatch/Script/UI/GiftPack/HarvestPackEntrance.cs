...
public class HarvestPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("HarvestTwoColumnPackMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > HarvestTwoColumnPackMenu.GiftPackStartTime && DateTime.Now < HarvestTwoColumnPackMenu.GiftPackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(HarvestTwoColumnPackMenu.GiftPackEndTime);
