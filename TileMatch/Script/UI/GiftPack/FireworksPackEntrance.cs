...
public class FireworksPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("FireworksPackMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > FireworksPackMenu.GiftPackStartTime && DateTime.Now < FireworksPackMenu.GiftPackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(FireworksPackMenu.GiftPackEndTime);
