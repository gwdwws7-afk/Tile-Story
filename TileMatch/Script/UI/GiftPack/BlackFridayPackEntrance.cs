...
public class BlackFridayPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("BlackFridayPackThreeColumnMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > BlackFridayPackThreeColumnMenu.GiftPackStartTime && DateTime.Now < BlackFridayPackThreeColumnMenu.GiftPackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(BlackFridayPackThreeColumnMenu.GiftPackEndTime);
