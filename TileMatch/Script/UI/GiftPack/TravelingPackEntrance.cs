...
public class TravelingPackEntrance : UIForm
{
    [SerializeField]
    ...
    private void OnButtonClick()
    {
        ...
        GameManager.UI.ShowUIForm("TravelingPackMenu");
    }


    private void UpdateBtnActiveAndTimer()
    {
        if (DateTime.Now > TravelingPackMenu.PackStartTime && DateTime.Now < TravelingPackMenu.PackEndTime &&
            GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockPackLevel)
        {
            ...
            countdownTimer.StartCountdown(TravelingPackMenu.PackEndTime);
