...
namespace MySelf.Model
{
    ...
    public class KitchenModel : BaseModel<KitchenModel, KitchenData>
    {
        ...
        public List<int> FinishedActivityIdList
        {
            get
            {
                if (Data.finishedActivityIdList == null) 
                    Data.finishedActivityIdList = new List<int>();
                return Data.finishedActivityIdList;
            }
        }
        
        public bool EverFinishedTargetActivityID(int targetActivityID)
        {
            return FinishedActivityIdList.Contains(targetActivityID);
        }

        public void RecordFinishedActivityId(int id)
        {
            if (!FinishedActivityIdList.Contains(id))
            {
                FinishedActivityIdList.Add(id);
                SaveToLocal();
            }
        }
