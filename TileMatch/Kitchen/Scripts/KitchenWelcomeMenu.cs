...
public class KitchenWelcomeMenu : UIForm
{
    ...
    public override void OnInit(UIGroup uiGroup, Action completeAction = null, object userData = null)
    {
        ...
        greyButton.gameObject.SetActive(GameManager.PlayerData.NowLevel < Constant.GameConfig.UnlockKitchenLevel);
        greenButton.gameObject.SetActive(GameManager.PlayerData.NowLevel >= Constant.GameConfig.UnlockKitchenLevel);
        
        buttonText.SetParameterValue("level", Constant.GameConfig.UnlockKitchenLevel.ToString());
    ...
    {
        GameManager.UI.ShowUIForm("KitchenExplainMenu", (form) =>
        {
            gameObject.SetActive(false);
            var uiform = form as KitchenExplainMenu;
