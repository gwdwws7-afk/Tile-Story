...
public class HarvestKitchenGameContinueMenu : PopupMenuForm, ICustomOnEscapeBtnClicked
{
    ...
    {
        needCoin = HarvestKitchenManager.Instance.GetContinueNeedCoin();
        ...
        switch (HarvestKitchenManager.Instance.toContinueMenuType)
        {
            case 0:
                ...
                if (HarvestKitchenManager.Instance.canWatchAdsContinue && GameManager.Ads.CheckRewardedAdIsLoaded() &&
    ...
    public void OnClickBuyBtn()
    {
        ...
        if (GameManager.PlayerData.UseItem(TotalItemData.Coin, needCoin))
        {
            ...
            // 增加接关次数
            HarvestKitchenManager.Instance.continueOfCoinNum += 1;
    ...
    {
        HarvestKitchenManager.Instance.canWatchAdsContinue = false;
    ...
    {
        // 记录关卡失败
        HarvestKitchenManager.Instance.ActivityLevelLose();
        
        GameManager.UI.HideUIForm(this);
        GameManager.UI.ShowUIForm("HarvestKitchenGameLoseMenu");
    }
    ...
    public void SetLisks(int cur, int total)
    {
        ...
        if (needCoin == 900 && HarvestKitchenManager.Instance.canWatchAdsContinue)
        {
