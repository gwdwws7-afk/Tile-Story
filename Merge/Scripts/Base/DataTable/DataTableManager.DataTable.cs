...
namespace Merge
{
    public sealed partial class DataTableManager : GameFrameworkModule, IDataTableManager
    {
        ...
        private sealed class DataTable<T> : DataTableBase, IDataTable<T> where T : class, IDataRow, new()
        {
            ...
            /// 获取编号最小的数据表行
            /// </summary>
            public T MinIdDataRow { get { return m_MinIdDataRow; } }

            /// <summary>
            /// 获取编号最大的数据表行
            /// </summary>
            public T MaxIdDataRow { get { return m_MaxIdDataRow; } }
            ...
            public override bool AddDataRow(object rawData)
            {
                try
                {
                    string dataRowString = (string)rawData;
