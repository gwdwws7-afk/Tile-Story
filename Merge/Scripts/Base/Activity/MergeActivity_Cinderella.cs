...
namespace Merge
{
    public class MergeActivity_Cinderella : MergeActivityBase
    {
        public override MergeTheme Theme => MergeTheme.Cinderella;

        public override string GroupName => "Merge_Cinderella";
        
        public override string AssetName => "MergeMainMenu_Cinderella";
