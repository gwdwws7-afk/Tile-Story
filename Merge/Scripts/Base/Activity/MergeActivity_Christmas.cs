...
namespace Merge
{
    public class MergeActivity_Christmas : MergeActivityBase
    {
        public override MergeTheme Theme => MergeTheme.Christmas;

        public override string GroupName => "Merge_Christmas";

        public override string AssetName => "MergeMainMenu_Christmas";
        ...
        public override void Initialize(DRMergeSchedule scheduleData)
        {
            ...
            LoadDataTable<DRChristmasBubbleReward>("ChristmasBubbleReward");
            LoadDataTable<DRChristmasBubbleConfig>("ChristmasBubbleConfig");
        }
        ...
        public override PropAttachmentLogic GetPropAttachmentLogic(string attachmentName)
        {
            switch (attachmentName)
            {
                ...
                case "Web":
                    return new WebLogic();
                case "Packingbox":
                    return new PackingboxLogic_Christmas();
            }
