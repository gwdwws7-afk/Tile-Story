...
namespace Merge
{
    public class MergeActivity_Halloween : MergeActivityBase
    {
        public override MergeTheme Theme => MergeTheme.Halloween;

        public override string GroupName => "Merge_Halloween";
        
        public override string AssetName => "MergeMainMenu_Halloween";

        public override string BgMusicName => "HALLOWEEN_MAP";
        ...
        public override PropAttachmentLogic GetPropAttachmentLogic(string attachmentName)
        {
            switch (attachmentName)
            {
                ...
                case "Web":
                    return new WebLogic();
                case "Packingbox":
                    return new PackingboxLogic_Halloween();
            }
        ...
        {
            return MergeManager.Merge.GetSquare(1, 2);
        }
    }
}
