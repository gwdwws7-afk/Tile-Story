...
namespace Merge
{
    public class MergeActivity_Cat : MergeActivityBase
    {
        public override MergeTheme Theme => MergeTheme.Cat;

        public override string GroupName => "Merge_Cat";

        public override string AssetName => "MergeMainMenu_Cat";
        ...
        public override void Initialize(DRMergeSchedule scheduleData)
        {
            ...
            LoadDataTable<DRChristmasBubbleReward>("CatBubbleReward");
            LoadDataTable<DRChristmasBubbleConfig>("CatBubbleConfig");
        }
