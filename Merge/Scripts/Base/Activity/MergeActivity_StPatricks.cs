...
namespace Merge
{
    public class MergeActivity_StPatricks : MergeActivityBase
    {
        public override MergeTheme Theme => MergeTheme.StPatricks;
        
        public override string GroupName => "Merge_StPatricks";

        public override string AssetName => "MergeMainMenu_StPatricks";
