...
namespace Merge
{
    //Items covered by cobwebs cannot be moved but can be merged!
    public sealed class Guide_Web : Guide
    {
        public Guide_Web(MergeGuideMenu guideMenu) : base(guideMenu)
        {
        }
        ...
        public override void OnTriggerGuide()
        {
            ...
            //����û���ǰ�ϵ��������ý̳�
            Square webSquare = MergeManager.Merge.GetSquare(3, 3);
