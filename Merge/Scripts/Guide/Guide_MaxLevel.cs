namespace Merge
{
    ...
    public sealed class Guide_MaxLevel : Guide
    {
        private PropLogic m_TargetProp;

        public Guide_MaxLevel(MergeGuideMenu guideMenu) : base(guideMenu)
        {
        }
        ...
        public override void OnTriggerGuide()
        {
            ...
            if (mainBoard != null && m_TargetProp != null && m_TargetProp.Square != null)
            {
                ...
                m_GuideMenu.Show("Merge.Guide6", m_TargetProp.Square.transform.position, 0.3f);
