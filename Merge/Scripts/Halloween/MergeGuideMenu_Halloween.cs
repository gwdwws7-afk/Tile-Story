...
namespace Merge
{
    public class MergeGuideMenu_Halloween : MergeGuideMenu
    {
        protected override void InitializeGuideList()
        {
            ...
            if (!CheckGuideIsComplete(GuideTriggerType.Guide_DragMerge)) m_GuideList.Add(new Guide_DragMerge_Halloween(this));
            ...
            if (!CheckGuideIsComplete(GuideTriggerType.Guide_Web)) m_GuideList.Add(new Guide_Web_Halloween(this));
        }
    }   
}
