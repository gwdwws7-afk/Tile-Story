...
namespace Merge
{
    //Hah, you think I'm scared? You'll never catch me!
    public sealed class Guide_DateMerge2 : Guide
    {
        public Guide_DateMerge2(MergeGuideMenu guideMenu) : base(guideMenu)
        {
        }

        public override GuideTriggerType GuideType => GuideTriggerType.Guide_DateMerge2;
        ...
        public override void OnTriggerGuide()
        {
            ...
            m_GuideMenu.Show("DateMerge.GuideDialog2", Vector3.zero, 0);
        ...
        public override void OnGuideFinish()
        {
            ...
            {
                m_GuideMenu?.TriggerGuide(Merge.GuideTriggerType.Guide_DateMerge3);
            });
        }
    }
}
