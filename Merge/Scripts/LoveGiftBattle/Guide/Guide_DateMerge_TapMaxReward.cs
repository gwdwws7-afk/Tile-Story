namespace Merge
{
    ...
    public sealed class Guide_DateMerge_TapMaxReward : Guide
    {
        private PropLogic m_TargetProp;

        public Guide_DateMerge_TapMaxReward(MergeGuideMenu guideMenu) : base(guideMenu)
        {
        }
        ...
        public override void OnTriggerGuide()
        {
            ...
            if (mainBoard != null && m_TargetProp != null && m_TargetProp.Square != null)
            {
                ...
                m_GuideMenu.Show("DateMerge.TapGeneratorGuide", m_TargetProp.Square.transform.position, 0.3f);
