...
namespace Merge
{
    //Wow! A crystal vein! Tap to start digging
    public sealed class Guide_DigDialog2 : Guide
    {
        public Guide_DigDialog2(MergeGuideMenu guideMenu) : base(guideMenu)
        {
        }

        public override GuideTriggerType GuideType => GuideTriggerType.Guide_DigDialog2;
        ...
        public override GuideState GetGuideState()
        {
            ...
            {
                if (MergeManager.Merge.GetSquare(2, 2).FilledProp == null) 
        ...
        public override void OnTriggerGuide()
        {
            ...
            Square targetSquare = MergeManager.Merge.GetSquare(2, 2);
            ...
            if (mainBoard != null)
            {
                ...
                m_GuideMenu.Show("DigMerge.GuideDialog2", new Vector3(0, mainBoard.m_PickaxeBarIcon.transform.position.y, 0), 0);
        ...
        public override void OnGuideFinish()
        {
            ...
            {
                m_GuideMenu?.TriggerGuide(GuideTriggerType.Guide_DigDialog3);
            });
        }
    }
}
