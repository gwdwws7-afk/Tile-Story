...
namespace Merge
{
    public class MergeGuideMenu_Dog : MergeGuideMenu
    {
        protected override void InitializeGuideList()
        {
            ...
            if (!CheckGuideIsComplete(GuideTriggerType.Guide_DecorateDogTree)) m_GuideList.Add(new Guide_DecorateDogTree(this));
        }
    }   
}
